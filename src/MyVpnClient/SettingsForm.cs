...
internal sealed class SettingsForm : Form
{
    ...
    private TabPage MakeTunnelPage()
    {
        ...
        AddRow(root, 2, "OC DPD sec", _openconnectDpdSecondsBox, "OpenConnect dead-peer detection interval passed as --force-dpd on the next connection. Default is 300 seconds. Use 0 to omit --force-dpd; OpenConnect/server defaults may still emit PPP DPD echo requests.");
